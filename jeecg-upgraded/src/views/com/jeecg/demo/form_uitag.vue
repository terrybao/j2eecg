  ...
  <div class="vue-component">
	...
	<table>
		<tr>
			...
			<td class="value"><t:dictSelect field="sex" type="radio" typeGroupCode="sex" hasLabel="false" title="性别" defaultVal="1"></el-select> 
		...
		<tr>
			...
			<td class="value"><t:dictSelect field="sex" type="select" typeGroupCode="sex" hasLabel="false" title="性别" defaultVal="1"></el-select> 
			<span class="Validform_checktip"></span>
			</td>
		</tr>
		<tr>
			<td align="center" width="100px"><label class="Validform_label">checkbox:</label></td>
			<td class="value"><t:dictSelect field="dbtype" type="checkbox" typeGroupCode="dbtype" hasLabel="false" title="数据库类型" defaultVal="oracle,mysql"></el-select> 
			<span class="Validform_checktip"></span>
			</td>
		</tr>
		<tr>
			<td align="center" width="100px"><label class="Validform_label">数据表字典:</label></td>
			<td class="value"><t:dictSelect field="name" defaultVal="1" dictTable="t_s_base_user" dictCondition="where delete_flag=0" dictField="username" dictText="realname" title="用户"></el-select> 
			<span class="Validform_checktip"></span>
			</td>
		</tr>
	</table>
