    ...
    <el-card>
      ...
      <el-form :inline="true" :model="searchForm" class="search-form">
        ...
        <el-form-item label="orderCode">
          <el-input v-model="searchForm.orderCode" placeholder="请输入orderCode"></el-input>
        </el-form-item>
        <el-form-item label="orderDate">
          <el-input v-model="searchForm.orderDate" placeholder="请输入orderDate"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      >
        ...
        <el-table-column prop="orderCode" label="orderCode" width="120"></el-table-column>
        <el-table-column prop="orderDate" label="orderDate" width="120"></el-table-column>
        <el-table-column prop="orderMoney" label="orderMoney" width="120"></el-table-column>
